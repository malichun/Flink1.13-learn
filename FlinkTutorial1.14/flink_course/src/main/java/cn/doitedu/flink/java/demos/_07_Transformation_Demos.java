...
/**
 * @author malichun
 * @create 2022/08/21 0021 21:54
 * 各类transformation 算子的演示
 */
public class _07_Transformation_Demos {
    public static void main(String[] args) throws Exception {
         ...
         */
        // 各性别用户的好友总数
        KeyedStream<Tuple2<String, Integer>, String> keyedStream = flatten.map(bean -> Tuple2.of(bean.getGender(), 1))
         ...
         * 同理，min和minBy也如此
         */
        SingleOutputStreamOperator<Tuple4<Integer, String, String, Integer>> tuple4Stream = beanStream
